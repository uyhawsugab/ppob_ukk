...
<head>
	...
	<title>DASHBOARD ADMIN | PPOB</title>
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						...
						<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@JSOFT.com">
							<span class="name"><?= $this->session->userdata('nama_admin'); ?></span>
					...
					<div class="dropdown-menu">
						<ul class="list-unstyled">
							...
							<li>
								<a role="menuitem" tabindex="-1" href="<?= base_url() ?>index.php/login_admin/logout"><i class="fa fa-power-off"></i> Logout</a>
							</li>
						</ul>
					</div>
				</div>
						...
						<nav id="menu" class="nav-main" role="navigation">
							<?php if ($this->session->userdata('id_level') == '1') : ?>
								<ul class="nav nav-main">
									...
									<li>
										<a href="<?= base_url() ?>index.php/users_admin">
